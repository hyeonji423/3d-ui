...
const Model = () => {
  ...
  useEffect(()=>{
    if(size === 'large'){
      animateGsapTimeline(tl, small, smallRotation, '#view1', '#view2', {transform: 'translateX(-100%)', duration: 1})
    }

    if(size === 'small'){
      animateGsapTimeline(tl, large, largeRotation, '#view2', '#view1', {transform: 'translateX(0%)', duration: 1})
    }
  }, [size])
