    ...
    <div>
      <div className='flex items-center'>
        ...
        <div className='relative flex-center mt-10'>
          <div className='flex-center py-5 px-7 bg-neutral-700 backdrop-blur-sm rounded-full'>
            {
              videoRef.current.map((_, idx)=>(
                <span key={idx} className='mx-2 w-3 h-3 bg-neutral-500 rounded-full relative' ref={(el)=>(videoContainerRef.current[idx]=el)}>

                  <span className='absolute h-full w-full rounded-full' ref={(el)=>(videoSpanRef.current[idx]=el)}></span>
